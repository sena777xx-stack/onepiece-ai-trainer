import{GameEngine}from'./game-engine-v3.js?v=3441';import{recordAiMatch}from'./ai-telemetry.js?v=3513';import{runSelfPlay}from'./ai-selfplay.js?v=3910';import{runAiTurn}from'./ai-engine.js?v=3880';import{storage}from'./storage.js';import{UI}from'./ui-fixed.js?v=3441';const root=document.querySelector('#app');let engine,attacker,playerDecks={},aiDecks={},cardCatalog={},selectedPlayerDeck='teach',selectedAiDeck='luffy';const json=async p=>{const r=await fetch(p);if(!r.ok)throw Error(p);return r.json()};
